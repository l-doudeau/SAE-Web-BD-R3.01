...
insert into RESERVER values(STR_TO_DATE("13-01-2014 08:30:00", "%d-%m-%Y %H:%i:%s"), 1, 1, 1, STR_TO_DATE("01:00:00", "%H:%i:%s"), true),
                            ...
                            (STR_TO_DATE('25-01-2022 17:31:00',"%d-%m-%Y %H:%i:%s"), 2, 10, 1, STR_TO_DATE('01:00:00', "%H:%i:%s"), true),
                            ...
                            (STR_TO_DATE('31-08-2022 18:00:00',"%d-%m-%Y %H:%i:%s"), 5, 3, 1, STR_TO_DATE('01:00:00', "%H:%i:%s"), true), 
